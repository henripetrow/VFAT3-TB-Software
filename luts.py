...
lim_EC_Errors = [0, 0, 'n', 'n']
lim_BC_Errors = [0, 0, 'n', 'n']
lim_CRC_Errors = [0, 0, 'n', 'n']
lim_Hit_Errors = [0, 0, 'n', 'n']
...
lim_IOVDD_Power_SLEEP = [59.167197, 100, 'n', 'n']
lim_Analog_Power_RUN = [64, 300, 'n', 'n']
lim_Digital_Power_RUN = [75.770665, 110, 'n', 'n']
lim_IOVDD_Power_RUN = [75.770665, 110, 'n', 'n']
