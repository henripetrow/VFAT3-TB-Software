...
connection = pymysql.connect(host="localhost", user="root", passwd="root", database="Hybrids")
...
production_table = ["ChipID INT(10)", "Barcode INT(10)", "ADC0M FLOAT(8)", "ADC0B FLOAT(8)", "ADC1M FLOAT(8)",
                    "ADC1B FLOAT(8)", "CAL_DACM FLOAT", "CAL_DACB FLOAT", "Iref INT", "Threshold FLOAT", "enc FLOAT",
                    "RegisterTest CHAR(10)", "EC_errors INT", "BC_errors INT", "CRC_errors INT", "Hit_errors INT",
                    "NoisyChannels CHAR(30)", "BIST BOOLEAN", "ScanChain BOOLEAN", "SLEEP_Power_analog FLOAT",
                    "SLEEP_Power_digital FLOAT", "RUN_Power_analog FLOAT",
                    "RUN_Power_digital FLOAT"]
